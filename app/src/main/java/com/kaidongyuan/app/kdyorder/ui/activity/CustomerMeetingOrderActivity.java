...
import com.kaidongyuan.app.kdyorder.model.CustomerMeetingOrderActivityBiz;
...
public class CustomerMeetingOrderActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener  {
    /**
     * 标题栏返回按钮
     */
     ...
     * 出库单业务类
     */
    private CustomerMeetingOrderActivityBiz mBiz;
    /**
     * 客户列表 ListView
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setListener();
        initOutputOrderlist();
        this.titleViewText.setText("查销售单");
    }
    ...
    private void initView() {
        try {
            ...
            this.mAdapter = new OutputSimpleOrderListAdapter(null, CustomerMeetingOrderActivity.this);
            mOutputOrderListView.setAdapter(mAdapter);
            this.titleViewText = (TextView) this.findViewById(R.id.title_view_text);
        } catch (Exception e) {
    ...
    private void initData() {
        try {
            if (getIntent().hasExtra(EXTRAConstants.ORDER_PARTY_ID)&&getIntent().hasExtra(EXTRAConstants.ORDER_PARTY_ADDRESS_IDX)){
                ...
                mBiz = new CustomerMeetingOrderActivityBiz(this, partyIdx);
            }else {
                finish();
            }
    ...
    private void showLoadingDialog() {
        try {
            if (mLoadingDialog == null) {
                mLoadingDialog = new MyLoadingDialog(CustomerMeetingOrderActivity.this);
            }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        try {
            Intent outputOrderDetailIntent = new Intent(CustomerMeetingOrderActivity.this, OutPutOrderDetailActivity.class);
