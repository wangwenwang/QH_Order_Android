 ...
 */
public class OutputInventoryActivityBiz {
    private OutputInventoryActivity mActivity;
    ...
    public OutputInventoryActivityBiz(OutputInventoryActivity activity) {
        ...
        try {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, URLCostant.GetOutProductList, new Response.Listener<String>() {
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("strLicense", "");
                    params.put("strProductType", mTempCurrentProductType);//左侧滑框所选类型，初始全部为“”
                    params.put("strProductClass", mTempCurrrentOrderBrand);//左侧滑框所选分类，初始全部为“”
                    return params;
                }
            };
