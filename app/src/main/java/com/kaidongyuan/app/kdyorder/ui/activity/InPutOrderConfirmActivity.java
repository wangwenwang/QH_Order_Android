...
import com.kaidongyuan.app.kdyorder.model.InPutOrderConfirmActivityBiz;
 ...
 */
public class InPutOrderConfirmActivity extends BaseFragmentActivity implements View.OnClickListener  {
    /**
     * 跳转到添加赠品界面时用到的常量
     */
     ...
     * 对应的业务类
     */
    private InPutOrderConfirmActivityBiz mBiz;
    ...
    public String strInputOrderType;
    ...
    private void initData() {
        try {
            ...
            mBiz = new InPutOrderConfirmActivityBiz(this);
    ...
    private void choiceGift() {
        try {
            ...
            if (mGiftCategoryData != null && mGiftCategoryData.size() > 0) {
                ...
                Intent intent1 = new Intent(InPutOrderConfirmActivity.this, AddGiftActivity.class);
        ...
        try {
            ...
            if (requestCode == ADDGIFT_REQUESCODE) {
                ...
                if (resultCode == Activity.RESULT_OK) {
                    Toast.makeText(InPutOrderConfirmActivity.this, "添加赠品成功", Toast.LENGTH_SHORT).show();
