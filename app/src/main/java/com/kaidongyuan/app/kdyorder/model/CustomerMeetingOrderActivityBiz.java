...
public class CustomerMeetingOrderActivityBiz {

    private CustomerMeetingOrderActivity mActivity;
    /**
     * 获取客户列表的网络请求标记
     */
    ...
    public CustomerMeetingOrderActivityBiz(CustomerMeetingOrderActivity activity, String PARTY_IDX) {
        try {
    ...
    private boolean GetOutPutOrders() {
        ...
        try {
            StringRequest request = new StringRequest(Request.Method.POST, URLCostant.GetAppOutPutList, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    Logger.w(CustomerMeetingOrderActivityBiz.this.getClass() + ".GetOutPutOrders:" + response);
                    GetOutPutOrdersSuccess(response);
                }
            }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    Logger.w(CustomerMeetingOrderActivityBiz.this.getClass() + ".GetOutPutOrders:" + error.toString());
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("ADD_USER", MyApplication.getInstance().getUser().getIDX());
                    params.put("strPage", mPageIndex + "");
                    params.put("strPageCount", mPageSize + "");
                    params.put("strPartyCode", "");
                    params.put("strPartyName", "");
                    params.put("strOrdNo", "");
                    params.put("strStartTime", "");
                    params.put("strEndTime", "");
