...
import com.kaidongyuan.app.kdyorder.adapter.InputSimpleOrderListAdapter;
...
import com.kaidongyuan.app.kdyorder.model.InputOrderlistActivityBiz;
 ...
 */
public class InputOrderListActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener  {
    /**
     * 标题栏返回按钮
     */
     ...
     * 下单业务类
     */
    private InputOrderlistActivityBiz mBiz;
    /**
     * 客户列表 ListView
     */
     ...
     * 客户列表
     */
    private InputSimpleOrderListAdapter mAdapter;
    /**
     * 没有数据时显示的控件，默认为不显示
     */
    ...
    private void initView() {
        try {
            ...
            title_view_text = (TextView) this.findViewById(R.id.title_view_text);
            title_view_text.setText("入库明细");
        } catch (Exception e) {
    ...
    private void initData() {
        try {
            if (getIntent().hasExtra(EXTRAConstants.ORDER_PARTY_ID)&&getIntent().hasExtra(EXTRAConstants.ORDER_PARTY_ADDRESS_IDX)){
                ...
                mBiz = new InputOrderlistActivityBiz(this, partyIdx);
            }else {
                finish();
            }
    ...
    private void handleRequest() {
        try {
            ...
            List<InPutSimpleOrder> outPutSimpleOrders = mBiz.getmOutputSimpleOrderList();
    ...
    private void showLoadingDialog() {
        try {
            if (mLoadingDialog == null) {
                mLoadingDialog = new MyLoadingDialog(InputOrderListActivity.this);
            }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        try {
            Intent outputOrderDetailIntent = new Intent(InputOrderListActivity.this, InPutOrderDetailActivity.class);
